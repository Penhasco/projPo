  ...
  protected final void execute() throws CommandException {
      ...
      try {
        ...
        if (isTextFile(filename)) {
          // Text files are not supported, so you can throw an exception or display a message
          throw new UnsupportedOperationException("Opening text files is not supported.");
        }
